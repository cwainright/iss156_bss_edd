...
options(warn=-1)
bob_2022_macroinvert_locations <- function(results_list, bob_2022_macroinvert, example){
    tryCatch(
        expr = {
            ...
            message(
                if(length(check_df$result == "MATCH") == nrow(check_df)){
                    "`bob_2022_macroinvert_locations()` executed successfully..."
                } else {
