...
edd_results <- function(
    ...
    tryCatch(
        expr = {
            ...
            real <- real %>%
                ...
                mutate(
                    Characteristic_Name = case_when(
                        ...
                        ,Characteristic_Name == "thienemannimyia group" ~ "thienemannimyia"
                        ,Characteristic_Name == "sf chironominae" ~ "chironominae"
                        ,Characteristic_Name == "sf tanypodinae" ~ "tanypodinae"
                        ,Characteristic_Name == "sperchonopsis spp." ~ "sperchonopsis"
                        ,Characteristic_Name == "bezzia sp group" ~ "bezzia"
            ...
            mysub <- real %>% subset(Characteristic_Name %like% "longitude")
