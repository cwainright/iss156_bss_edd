...
options(warn=-1)
ncrn_macroinvert_activities <- function(results_list, example){
    tryCatch(
        expr = {
            ...
            real[2] <- "Biological Stream Survey - stream benthic macroinvertebrate monitoring" # df$Protocol_Name # "Project_ID"
            ...
            message(
                if(length(check_df$result == "MATCH") == nrow(check_df)){
                    "`ncrn_macroinvert_activities()` executed successfully..."
                } else {
