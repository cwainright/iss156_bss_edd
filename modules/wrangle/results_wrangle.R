            ...
            real <- real %>%
                ...
                mutate(
                    Characteristic_Name = case_when(
                        ...
                        ,Characteristic_Name == "water logger dewatered" ~ "instrumentation or event data - water logger dewatered status"
                        ...
                        ,Characteristic_Name == "sample is a blank or a duplicate" ~ "instrumentation or event data - water quality-control sample collected"
                ...
                mutate(
                    Result_Unit = case_when(
                        ...
                        ,Characteristic_Name %like% "sulfate" ~ "milligrams per liter"
                        ,Characteristic_Name %like% "ammonia" ~ "milligrams per liter"
                        ,Characteristic_Name %like% "chloride" ~ "milligrams per liter"
                        ,Characteristic_Name %like% "nitrate" ~ "milligrams per liter"
                        ,Characteristic_Name %like% "nitrite" ~ "milligrams per liter"
                        ,Characteristic_Name %like% "total nitrogen" ~ "milligrams per liter"
                        ,Characteristic_Name %like% "total phosphorus" ~ "milligrams per liter"
                        ,Characteristic_Name %like% "orthophosphate" ~ "milligrams per liter"
                        ,Characteristic_Name %like% "dissolved organic carbon" ~ "milligrams per liter"
                        ,Characteristic_Name %like% "acid neutralizing capacity" ~ "microequivalents per liter"
                        ,Characteristic_Name %like% "specific conductance" ~ "microsiemens per centimeter"
                        ...
                        ,Characteristic_Name == "instrumentation or event data - water logger dewatered status" ~ "N = not dewatered; Y = dewatered"
                        ,Characteristic_Name == "instrumentation or event data - water quality-control sample collected" ~ "N = not collected; Y = collected"
